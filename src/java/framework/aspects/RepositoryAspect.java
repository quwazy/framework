...
public class RepositoryAspect {
    ...
    public void aroundRepositoryMethods(ProceedingJoinPoint joinPoint) {
        ...
        System.out.println("Declaring type name: " + joinPoint.getSignature().getDeclaringTypeName());      //full package nema klase u kojoj je presretnuta funckija
        System.out.println("Modifiers: " + Modifier.toString(joinPoint.getSignature().getModifiers()));        //predstavlja kog je tipa funckija koju smo presreli(public, private, abstact)
